...
from others.train_3cgan import SourceCNN  # 从train.py导入模型定义
...
# 数据加载函数（修改为你的测试数据路径）
def load_target_data(data_path='E:/wifi感知/5300-1_npy/'):
    # 加载训练集数据
...
def adapt_3cgan(source_model, target_loader):
    ...
    for epoch in range(EPOCHS):
        ...
        # 每轮结束后评估准确率
        accuracy = evaluate(source_model, target_loader)
